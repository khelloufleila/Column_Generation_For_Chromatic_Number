...
public class Parameters {
	...
	public static class ColGen {
		// All this values are just like a first implementation
	...
	public static void configureCplex(ColumGeneration.MasterProblem masterproblem) {
	...
	public static void configureCplex(ColumGeneration.SubProblem subproblem) {
		try {
			// branch and bound
